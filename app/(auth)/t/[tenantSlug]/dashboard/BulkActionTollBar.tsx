...
import { CheckCircle, UserPlus, Loader2, ChevronUp } from "lucide-react";
import { bulkUpdateIncidents } from "@/lib/actions/incidents";
import { getTenantUsers } from "@/lib/actions/users";
import { useState, useEffect } from "react";

export default function BulkActionToolbar({ selectedIds, tenantId, userId }: any) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
      {/* Container with overflow-hidden to clip the progress bar corners */}
